...
# 1 Test whether the assumption of Gaussian residuals 
# holds for the R formula Weight ~ Length1 for perch 
# in the fish dataset. Describe the evidence for why 
# or why not; show your code.



# 2 Perform the regression for Weight ~ Height for the 
# species Bream. Assess whether the residuals fit the 
# Gaussian assumption. Present any graphical tests or 
# other results and your conclusion in the scientific style.



# 3 For the analysis in #2 above present the results 
# of your linear regression (if the residuals fit the 
# Gaussian assumption) or a Spearman rank correlation 
# (if they did not).


# 4 Plot perch$Weight ~ perch$Length2. The relationship 
# is obviously not linear but curved. Devise and execute 
# a solution to enable the use of linear regression, 
# possibly by transforming the data. Show any relevant 
# code and briefly explain your results and conclusions.



# 5 Explore the data for perch and describe the 
# covariance of all of the morphological, 
# numeric variables using all relevant means, 
# while being as concise as possible. Show your code.



# 6 Write a plausible practice question involving 
# the the exploration or analysis of regression. 
# Make use of the fish data from any species except 
# for Perch.
